...
export const AdminDashboard: React.FC = () => {
  ...
  const clicEnBotonNavegacion = useRef(false);
...
// para regresar siempre a la pagina 1 cuando cambie el centro de negocio
  ...
  const navigateToHI = () => {
    clicEnBotonNavegacion.current = true; // activamos el ref para que el useEfect sea verdadero una ves que los datos llegen y navege
  }
