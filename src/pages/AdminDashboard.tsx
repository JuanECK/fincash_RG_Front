...
// =============================================================================================
  ...
  // const evaluaSignoCompra = (precio:string) => {
  //   let respuesta = false;
  //    precio.charAt(0) === '+' ? 
  //   return respuesta
  // }
    ...
    <div className="dashboard-layout">
      ...
      <main className="main-content-panel">
        ...
        <section className="stats-card-header"> 
          <div className="flex justify-between items-center">
            ...
            <div className="flex ">
              <div className="rounded-full px-6 pb-1 pt-2 bg-(--MediumBlue)">
                <button type="button" className="transition-all cursor-pointer ">
              ...
              <div className="">
                <button type="button" className=" rounded-full px-4  py-3  bg-(--MediumBlue) hover:bg-(--DeepBlue) transition-all cursor-pointer ">
      ...
      {/* {!detallesCliente ? (
        ...
        <div className="flex-1 flex flex-col min-h-[300px]">
          ...
          <div className="purchase-history-box pr-1 overflow-y-auto max-h-[420px] scrollbar-thin scrollbar-thumb-[#155A6F] scrollbar-track-transparent">
