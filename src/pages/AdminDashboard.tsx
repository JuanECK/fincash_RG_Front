                    ...
                    >
                      ...
                      <td className="rounded-tl-full rounded-bl-full rounded-tr-full rounded-br-full ">
                        <div className="flex justify-center gap-2 ">
                          {/* Agregar gasto */}
                          <button type="button" onClick={()=> setShowModalGasto(true)} className="action-icon-btn">
                            <span>
                              <svg
                                width="14"
                                height="13"
                          ...
                          {/* Abono */}
                          <button type="button" onClick={() => setShowModalAbono(true)} className="action-icon-btn">
                            <span>
                              <svg
                                width="16"
                                height="10"
